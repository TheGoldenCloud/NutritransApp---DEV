    ...
    dani: [
      {
        ...
        Obrok: { type: String, required: false, default: "" },
        Jelo: { type: String, required: false, default: "" },
        Kalorije_ukupno: { type: Number, required: false, default: 0 },
        Priprema: { type: String, required: false, default: "" },
        Namirnice: [
          {
            Naziv: { type: String, required: false, default: "" },
            Kalorije: { type: Number, required: false, default: 0 },
            Grami: { type: Number, required: false, default: 0 },
            Proteini_g: { type: Number, required: false, default: 0 },
            Masti_g: { type: Number, required: false, default: 0 },
            Seceri_g: { type: Number, required: false, default: 0 },
          },
        ],
      },
    ],
