let organizacije = [
    {
        ...
        zaposleniList:[
            { jmbg: "0204997710082", pozicija: { pozicijaId: "35793", pozicijaName: "Konobar" }, sektor: {sektorId: "758493", sektorName: "Banket" }, netopalataIzUgovora: "50.000", fixUgovoren: "70.000", tipUgovora: {tipUgovoraId: "83625", tipUgovoraName: "Na odrednjeno" }, kafa: "Da", zaRacDnev: "Da" },
            { jmbg: "1325620710084", pozicija: "Kuvar", sektor: "Kuhinja", netopalataIzUgovora: "60.000", fixUgovoren: "90.000",  tipUgovora: "Na neodrednjeno", kafa: "Da",zaRacDnev: "Ne" }
        ],
    },
    {
        idOrg: "371",
        ...
        zaposleni:[
            { jmbg: "0204997710082", pozicija: { pozicijaId: "347748", pozicijaName: "Piljar" }, sektor: {sektorId: "2464568", sektorName: "KRoc" }, netopalataIzUgovora: "50.000", fixUgovoren: "70.000", tipUgovora: {tipUgovoraId: "45745", tipUgovoraName: "Na 2 meseca" }, kafa: "Da", zaRacDnev: "Da" },
            { jmbg: "2859245854368", pozicija: "Konobar", sektor: "Kuhinja", netopalataIzUgovora: "60.000", tipUgovora: "Na neodrednjeno", fixUgovoren: "90.000", kafa: "Da",zaRacDnev: "Ne" }
        ],
    },
        {
        idOrg: "385",
        ...
        zaposleni:[
            { jmbg: "0204997710082", pozicija: "Kuvar", sektor: "Banket", netopalataIzUgovora: "50.000", tipUgovora: "Na odrednjeno",fixUgovoren: "70.000", kafa: "Da", zaRacDnev: "Da" },
            { jmbg: "2859245854368", pozicija: "Konobar", sektor: "Kuhinja", netopalataIzUgovora: "60.000", tipUgovora: "Na neodrednjeno", fixUgovoren: "90.000", kafa: "Da",zaRacDnev: "Ne" }
        ],
    }
]
...
let zaposleni = [
    { ime: "Jovan", prezime: "Jovanovic", jmbg: "2938692690637", valuta: "Eur", status: "Aktivan" },
    { ime: "Ana", prezime: "Ivanovic", jmbg: "1325620710084", valuta: "Rsd", status: "Neaktivan" },
    { ime: "Marija", prezime: "Matic", jmbg: "0204997710082", valuta: "Rsd", status: "Aktivan" },
    { ime: "Rade", prezime: "Nikolic", jmbg: "2859245854368", valuta: "Eur", status: "Aktivan" }
];
...
let data = {
    zaposlen: { ime: "Jovan", prezime: "Jovanovic", jmbg: "2938692690637", valuta: "Eur", status: "Aktivan" },
    organizacije: {
        890: { jmbg: "0204997710082", pozicija: "Konobar", sektor: "Banket", netopalataIzUgovora: "50.000", fixUgovoren: "70.000", tipUgovora: "Na odrednjeno", kafa: "Da", zaRacDnev: "Da" },
        371: { jmbg: "0204997710082", pozicija: "Kuvar", sektor: "Banket", netopalataIzUgovora: "50.000", fixUgovoren: "70.000", tipUgovora: "Na neodrednjeno", kafa: "Da", zaRacDnev: "Da" },
    }
}
...
let a = {
    "66912365d2672debd94a4412": {organizacijaId:"66912365d2672debd94a4412",  fixUgovoren:"2323", selectedOptionKafa:"Ne", selectedOptionDnevnica:"Da" },
    "976349052426783449562956": {organizacijaId:"976349052426783449562956",  fixUgovoren:"9548", selectedOptionKafa:"Ne", selectedOptionDnevnica:"Ne" },
    "374289360529734609256478": {organizacijaId:"374289360529734609256478",  fixUgovoren:"6950", selectedOptionKafa:"Da", selectedOptionDnevnica:"Da" }
}
...
<div className="sm:col-span-1">
    <label htmlFor="procenatKazna" className="block text-sm font-medium leading-6 text-gray-900">Procenat</label>
    <div className="mt-1">
        <input type="number" value={procenatKazna} onChange={onProcenatKaznaChanged} name="procenatKazna" id="procenatKazna" autoComplete="procenatKazna" className="block w-full rounded border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6" />
...
let ishrana = {
    id:"a8w94y983y9",
    naziv: "Keto",
    komentar: "Ovo je ishrana gde sam određuješ koje namirnice jedeš a koje ne. Ovo je verovatno najbolji vid ishrane ako poznaješ dovoljno sebe i odlučan si u tome šta voliš a šta ne. U okviru opcije Tvoja ishrana možeš da menjaš namirnice. ",
    namirnice: [
        {
            id:"sfdg7d86f598",
            ime: "Celer",
    ...
    povrce: {
        lisnato: ["Spanać", "Blitva", "Kelj", "Zelena salata","Rukola","Matovilac","Celer"],
    ...
    zitarice: {
        celovite: ["Pšenica", "Ječam", "Ovas", "Raž","Spelta","Heljda","Proso","Pririnač (integralni)","Kukuruz"],
        proizOdCelZit:["Hleb od celovitog zrna", "Integralna Testenina", "Ovsena kaša"],
        rafinisane: ["Beli hleb", "Beli pirinač", "Obična testenina","Keks","Kolač"]
    },
    mlecniProiz: {
    ...
    mesoRibaJaja: {
        ...
        ribImorsPlod: ["Šaran","Som","Pastrmka","Smudj","Deverika","Kečiga","Štuka","Losos","Tuna","Bakalar","Lignje","Skuša","Škampi"],
        preradj: ["Šunka","Slanina","Kobasice","Salama","Pašteta","Mesni narezak"],
...
let maneUHrani = {
    gluten: ["Pšenica","Ječam","Ovas","Raž","Spelta","Hleb od celovitog zrna","Integralna Testenina", "Ovsena kaša","Beli hleb","Obična testenina","Keks","Kolač"], //Izbacujem sve
    laktoza: ["Kravlje","Običan","Grčki","Voćni","Gauda","Edamer","Feta","Parmezan","Mozzarela","Rikota","Kefir","Kiselo mleko","Kisela pavlaka","Slatka pavlaka","Maslac"], //Izbacujem sve
    //Izbacujem pojedinacno selektovano
    alergeni: ["Celer","Soja","Badem","Orah","Lešnik","Indijski orah","Kikiriki","Susam","Pšenica","Ječam","Ovas","Raž","Kravlje mleko","Kozije mleko","Sojno mleko","Bademovo mleko","Šaran","Som","Pastrmka","Smudj","Deverika","Kečiga","Štuka","Losos","Tuna","Bakalar","Lignje","Skuša","Škampi"," jaja"],
}
...
let odabranenami = ["671f5bec5997900563cea6d1","671f5b785997900563cea6a7","671f5d265997900563cea74f","671f6cc85997900563ceaa70"]
...
const [odabraneNamirnice, setOdabraneNamirnice] = useState([
    '671f99bfd1348708c15bae5f', '671f98fad1348708c15badd9', 
    '671f98dbd1348708c15badbb', '671f990ad1348708c15bade8', 
    '671f98ebd1348708c15badca', '671f98cbd1348708c15badac',
    '671f98b7d1348708c15bad9d', '671f98a3d1348708c15bad8e',
    '671f988ed1348708c15bad7f', '671f987dd1348708c15bad70',
    '671f986dd1348708c15bad61', '671f985cd1348708c15bad52',
    '671f9844d1348708c15bad43', '671f9835d1348708c15bad34',
    '671f951ed1348708c15babd5', '671f94f5d1348708c15babc6',
    '671f94b6d1348708c15babb7', '671f948cd1348708c15baba8',
    '671f82c75997900563cead79', '671f82b35997900563cead6a',
    '671f829b5997900563cead5b', '671f82735997900563cead4c',
    '671f81ba5997900563cead19', '671f81705997900563ceace8',
    '671f81595997900563ceacd9', '671f81445997900563ceacca',
    '671f81335997900563ceacbb', '671f81235997900563ceacac',
    '671f80aa5997900563ceac9d', '671f6daf5997900563ceaae0'
  ]);
...
let ishranee = [
    {
        ...
        naziv: "Tvoja ishrana",
        komentar: "Ovo je ishrana gde sam određuješ koje namirnice jedeš, a koje ne. Ovo je verovatno najbolji vid ishrane ako poznaješ dovoljno sebe i odlučan si u tome šta voliš a šta ne.",
        namirnice: [
    ...
    },
    {
        ...
        naziv: "Keto dijeta",
        komentar: "Popularna zbog svojih brzih rezultata u gubitku težine, ova dijeta je niskougljenična i visokomasna. Posebno je popularna među ljudima koji žele da brzo izgube težinu.",
        namirnice: [
    ...
    },
    {
        ...
        komenta: "Ova dijeta je poznata po svojim zdravstvenim prednostima, uključujući smanjenje rizika od kardiovaskularnih bolesti. Ona se fokusira na unos voća, povrća, ribe, maslinovog ulja, i celih žitarica.",
        namirnice: [
    ...
    },
    {
        ...
        komentar: "Sve veći broj ljudi prelazi na veganstvo zbog zdravstvenih, etičkih ili ekoloških razloga. Važno je ponuditi planove ishrane koji su potpuno bazirani na biljkama.",
        namirnice: [
